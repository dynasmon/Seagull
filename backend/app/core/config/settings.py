...
class Settings:
    ...
    SEAGULL_REALTIME_DASHBOARD_INVALIDATE_ENABLED: bool = _env_bool(
        "SEAGULL_REALTIME_DASHBOARD_INVALIDATE_ENABLED", True
    )
    SEAGULL_REALTIME_DASHBOARD_INVALIDATE_MIN_INTERVAL_SECONDS: int = _env_int(
        "SEAGULL_REALTIME_DASHBOARD_INVALIDATE_MIN_INTERVAL_SECONDS", 5
    )
    ...
    SEAGULL_AGENT_RELEASE_VERSION: str = _env_str("SEAGULL_AGENT_RELEASE_VERSION", "0.1.1") or "0.1.1"
