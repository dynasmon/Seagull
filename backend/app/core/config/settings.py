...
class Settings:
    ...
    SEAGULL_EVENTS_SUMMARY_FRESH_SECONDS: int = _env_int("SEAGULL_EVENTS_SUMMARY_FRESH_SECONDS", 45)
    SEAGULL_EVENTS_SUMMARY_STALE_SECONDS: int = _env_int("SEAGULL_EVENTS_SUMMARY_STALE_SECONDS", 300)
    SEAGULL_CH_WATERMARK_STALE_SECONDS: int = _env_int("SEAGULL_CH_WATERMARK_STALE_SECONDS", 30)
    ...
    SEAGULL_ANALYTICS_PREWARM_EVERY_SECONDS: float = _env_float("SEAGULL_ANALYTICS_PREWARM_EVERY_SECONDS", 45.0)
    SEAGULL_ANALYTICS_PREWARM_TOP_AGENTS: int = _env_int("SEAGULL_ANALYTICS_PREWARM_TOP_AGENTS", 8)
