...
REALTIME_EVENT_POLICIES: dict[str, dict[str, str]] = {
    ...
    "ui.exposure.invalidate": {"topic": "exposure", "mode": "invalidate", "scope": STREAM_TOKEN_SCOPE},
    "exposure.summary.updated": {"topic": "exposure", "mode": "patch", "scope": STREAM_TOKEN_SCOPE},
    "exposure.asset.updated": {"topic": "exposure", "mode": "patch", "scope": STREAM_TOKEN_SCOPE},
    "exposure.finding.updated": {"topic": "exposure", "mode": "patch", "scope": STREAM_TOKEN_SCOPE},
...
TOPIC_INVALIDATE_EVENT: dict[str, str] = {
    ...
    "exposure": "ui.exposure.invalidate",
